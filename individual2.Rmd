...
```{r}
states$`State Code` <- as.numeric(states$`State Code`)
states$`County Code` <- as.numeric(states$`County Code`)
states$`Country Code` <- as.numeric(states$`Country Code`)
states$`City Code` <- as.numeric(states$`City Code`)
```
